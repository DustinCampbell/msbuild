...
public class OneOrMany_Tests
{
    ...
    [Fact]
    public void SpanConstructorPreservesNoValues()
    {
        OneOrMany<int> values = new([]);
    ...
    [Fact]
    public void SpanConstructorPreservesOneValue()
    {
        OneOrMany<int> values = new([42]);
        ...
        GetValues(values).ShouldBe([42]);
    }

    [Fact]
    public void SpanConstructorPreservesOneDefaultValue()
    {
        OneOrMany<string?> values = new([null]);
    ...
    [Fact]
    public void SpanConstructorPreservesManyValues()
    {
        OneOrMany<int> values = new([10, 20, 30]);
    ...
    public void ItemRefUncheckedReturnsInlineAndAdditionalValues()
    {
        ...
        ref readonly string firstReference = ref OneOrMany<string>.ItemRef(in values, 0);
        ref readonly string secondReference = ref OneOrMany<string>.ItemRef(in values, 1);
