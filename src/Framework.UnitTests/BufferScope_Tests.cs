...
namespace Microsoft.Build.Buffers.UnitTests;
...
public class BufferScope_Tests
{
    ...
    [Fact]
    public unsafe void Construct_WithStackAlloc_Pin()
    {
        using BufferScope<char> buffer = new(stackalloc char[10]);
        buffer.Length.ShouldBe(10);
        buffer[0] = 'Y';
    ...
    [Fact]
    public unsafe void Construct_Pin()
    {
    ...
    public void CombinedOperations_ComplexScenario()
    {
        ...
        // Test enumeration
        Span<int> firstFive = buffer.AsSpan()[..5];
        var values = new List<int>();
