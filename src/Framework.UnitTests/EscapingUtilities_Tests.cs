...
public sealed class EscapingUtilities_Tests
{
    ...
    public void Unescape(string input, string expected)
        => Assert.Equal(expected, EscapingUtilities.UnescapeAll(input));
    ...
    public void Escape(string input, string expected)
        => Assert.Equal(expected, EscapingUtilities.Escape(input));
    ...
    public void ContainsEscapedWildcards(string input, bool expected)
        => Assert.Equal(expected, EscapingUtilities.ContainsEscapedWildcards(input));
}
