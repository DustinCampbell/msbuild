...
public class StringExtensions_Tests
{
    ...
    public void ReplaceWithStringComparerTest(
        string s, string oldValue, string? newValue, StringComparison stringComparison, string expectedResult)
        => s.Replace(oldValue, newValue, stringComparison).ShouldBe(expectedResult);
    ...
    public void ReplaceWithStringComparerExceptionCases(
        string? s, string? oldValue, string? newValue, StringComparison stringComparison, Type expectedException)
        => Should.Throw(() => s!.Replace(oldValue!, newValue, stringComparison), expectedException);
}
