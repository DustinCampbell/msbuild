    ...
    internal static class ResourceUtilities
    {
        ...
        private static void ValidateArgsIfDebug(object?[] args)
        {
            ...
            foreach (object? param in args)
            {
                ...
                if (param != null)
                {
                    ...
                    {
                        Assumed.Unreachable($"Invalid resource parameter type, was {param.GetType().FullName}");
                    }
                }
            }
        }
        ...
        internal static void VerifyResourceStringExists(string resourceName)
        {
            try
            {
                ...
                {
                    Assumed.Unreachable($"""The resource string "{resourceName}" was not found.""");
                }
            }
