...
/// </summary>
/// <remarks>
/// FUTURE: This class could accept an optional inner exception to put in the
...
internal static class ProjectErrorUtilities
{
        ...
        params object?[]? args)
    {
        ...
        string? errorSubCategory = errorSubCategoryResourceName is not null
            ? AssemblyResources.GetString(errorSubCategoryResourceName)
            : null;

        string message = ResourceUtilities.FormatResourceStringStripCodeAndKeyword(out var errorCode, out var helpKeyword, resourceName, args);

        throw new InvalidProjectFileException(
            projectFile: elementLocation.File,
            lineNumber: elementLocation.Line,
            columnNumber: elementLocation.Column,
            endLineNumber: 0 /* Unknown end line */,
            endColumnNumber: 0 /* Unknown end column */,
            message,
            errorSubCategory,
            errorCode,
            helpKeyword);
