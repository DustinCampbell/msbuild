...
#else
            => TryParseInt32(value, NumberStyles.Integer, NumberFormatInfo.InvariantInfo, out result) ||
...
#else
            => (CanUseIntegerFastPath(style) &&
                    TryParseInt32(value, style, NumberFormatInfo.GetInstance(provider), out result))
...
#else
            => TryParseInt64(value, NumberStyles.Integer, NumberFormatInfo.InvariantInfo, out result) ||
...
#else
            => (CanUseIntegerFastPath(style) &&
                    TryParseInt64(value, style, NumberFormatInfo.GetInstance(provider), out result))
...
#else
            => (CanUseIntegerFastPath(style) &&
                    TryParseUInt32(value, style, NumberFormatInfo.GetInstance(provider), out result))
...
#else
            => (CanUseIntegerFastPath(style) &&
                    TryParseInt64AsDouble(value, style, NumberFormatInfo.GetInstance(provider), out result))
