...
internal static partial class FrameworkFileUtilities
{
    ...
    private static Lazy<string> s_lazyTempFileDirectory = CreateLazyTempFileDirectory();

    private static Lazy<string> CreateLazyTempFileDirectory() => new(
        () =>
        {
    ...
    public static string TempFileDirectory => s_lazyTempFileDirectory.Value;

    internal static void ClearTempFileDirectory()
    {
        s_lazyTempFileDirectory = CreateLazyTempFileDirectory();
    }
    ...
    public sealed class TempWorkingDirectory : IDisposable
    {
        ...
        public TempWorkingDirectory(string sourcePath, [CallerMemberName] string name = "")
        {
            Path = name == null
