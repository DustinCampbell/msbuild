            ...
            try
            {
                ...
                do
                {
                    ...
                    if (memoryStream != null)
                    {
                        ...
                        if (n < 0)
                        {
                            Assumed.Unreachable($"From calculating based on the memorystream, about to read n = {n}. length = {length}, rawPosition = {rawPosition}, readLength = {readLength}, stringLength = {stringLength}, currPos = {currPos}.");
                        }
                    ...
                    if (rawBuffer == null)
                    {
                        ...
                        if (n < 0)
                        {
                            Assumed.Unreachable($"From getting the length out of BaseStream.Read directly, about to read n = {n}. readLength = {readLength}, stringLength = {stringLength}, currPos = {currPos}");
                        }
                    }
