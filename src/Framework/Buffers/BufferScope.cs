...
namespace Microsoft.Build.Buffers;
...
internal ref struct BufferScope<T>
{
    ...
    /// <summary>
    ///  Initializes a new instance of the <see cref="BufferScope{T}"/> struct with a minimum length.
    /// </summary>
    ...
    /// <summary>
    ///  Initializes a new instance of the <see cref="BufferScope{T}"/> struct with an initial buffer.
    ///  Useful for creating with an initial stack allocated buffer.
    /// </summary>
    ...
    /// <summary>
    ///  Initializes a new instance of the <see cref="BufferScope{T}"/> struct with an initial buffer and a minimum length.
    ///  Useful for creating with an initial stack allocated buffer.
    /// </summary>
    /// <param name="initialBuffer">The initial buffer to use.</param>
    ...
    {
        Debug.Assert(capacity > _span.Length, "Capacity must be greater than the current span length.");
    ...
    /// </summary>
    /// <returns>
    ///  A span that represents the buffer.
    /// </returns>
