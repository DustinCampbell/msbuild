...
namespace Microsoft.Build.Shared
{
    ...
    internal abstract class AssemblyLoadInfo : ITranslatable, IEquatable<AssemblyLoadInfo>
    {
        ...
        {
            Assumed.True((!string.IsNullOrEmpty(assemblyName)) || (!string.IsNullOrEmpty(assemblyFile)),
                "We must have either the assembly name or the assembly file/path.");
            Assumed.True((assemblyName == null) || (assemblyFile == null),
        ...
        {
            Assumed.True(translator.Mode == TranslationDirection.WriteToStream, "write only");
