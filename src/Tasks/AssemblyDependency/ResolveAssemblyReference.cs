...
namespace Microsoft.Build.Tasks
{
    ...
    public class ResolveAssemblyReference : TaskExtension, IIncrementalTask
    {
        ...
        public string[] TargetFrameworkSubsets
        {
            ...
            set
            {
                ArgumentNullException.ThrowIfNull(value, paramName: nameof(TargetFrameworkSubsets));
        ...
        public ITaskItem[] InstalledAssemblySubsetTables
        {
            ...
            set
            {
                ArgumentNullException.ThrowIfNull(value, paramName: nameof(InstalledAssemblySubsetTables));
        ...
        public ITaskItem[] FullFrameworkAssemblyTables
        {
            ...
            set
            {
                ArgumentNullException.ThrowIfNull(value, paramName: nameof(FullFrameworkAssemblyTables));
        ...
        public string[] FullTargetFrameworkSubsetNames
        {
            ...
            set
            {
                ArgumentNullException.ThrowIfNull(value, paramName: nameof(FullTargetFrameworkSubsetNames));
        ...
        public string ProfileName
        {
            ...
            set
            {
                ArgumentNullException.ThrowIfNull(value, paramName: "profileName");
                _profileName = value;
            }
        }
        ...
        public string[] FullFrameworkFolders
        {
            ...
            set
            {
                ArgumentNullException.ThrowIfNull(value, paramName: nameof(FullFrameworkFolders));
