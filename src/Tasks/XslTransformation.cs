...
namespace Microsoft.Build.Tasks
{
    ...
    public class XslTransformation : TaskExtension, IMultiThreadableTask
    {
        ...
        public override bool Execute()
        {
            ...
            {
                Log.LogErrorWithCodeFromResources("General_TwoVectorsMustHaveSameLength", _outputPaths.Length, XmlInputPaths.Length, "OutputPaths", "XmlInputPaths");
                return false;
            }
            ...
            {
                Log.LogErrorWithCodeFromResources("General_TwoVectorsMustHaveSameLength", _outputPaths.Length, 1, "OutputPaths", "XmlContent");
                return false;
            }
