...
namespace Microsoft.Build.Tasks
{
    ...
    public class ResolveNativeReference : TaskExtension, IResolveNativeReferenceTaskConract
    {
        ...
        public ITaskItem[] NativeReferences
        {
            get
            {
                ArgumentNullException.ThrowIfNull(_nativeReferences, paramName: nameof(NativeReferences));
        ...
        public string[] AdditionalSearchPaths
        {
            get
            {
                ArgumentNullException.ThrowIfNull(_additionalSearchPaths, paramName: nameof(AdditionalSearchPaths));
