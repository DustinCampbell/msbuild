...
namespace Microsoft.Build.Tasks
{
    ...
    public class FindAppConfigFile : TaskExtension
    {
        ...
        public ITaskItem[] PrimaryList
        {
            get
            {
                ArgumentNullException.ThrowIfNull(_primaryList, paramName: nameof(PrimaryList));
                return _primaryList;
            }
        ...
        public ITaskItem[] SecondaryList
        {
            get
            {
                ArgumentNullException.ThrowIfNull(_secondaryList, paramName: nameof(SecondaryList));
