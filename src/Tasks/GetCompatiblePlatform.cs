    ...
    public class GetCompatiblePlatform : TaskExtension
    {
        ...
        public override bool Execute()
        {
            ...
            for (int i = 0; i < AnnotatedProjects.Length; i++)
            {
                ...
                Log.LogMessageFromResources(MessageImportance.Low, "GetCompatiblePlatform_DisplayChosenPlatform", AssignedProjectsWithPlatform[i].ItemSpec, buildProjectReferenceAs);
            }
