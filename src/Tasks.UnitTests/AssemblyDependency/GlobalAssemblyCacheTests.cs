...
namespace Microsoft.Build.UnitTests.ResolveAssemblyReference_Tests
{
    ...
    public sealed class GlobalAssemblyCacheTests : ResolveAssemblyReferenceTestFixture
    {
        ...
        private readonly GacTestServices _gacServices = new GacTestServices();
        ...
        public void SystemRuntimeDepends_Yes_Indirect_ExternallyResolved()
        {
            ...
            Assert.True(t.Execute(DefaultServices));
        ...
        {
            private readonly List<string> _assembliesToEnumerate;
