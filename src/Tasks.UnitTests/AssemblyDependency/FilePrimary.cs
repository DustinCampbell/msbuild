...
public sealed class FilePrimary(ITestOutputHelper output) : ResolveAssemblyReferenceTestFixture(output)
{
    /// <summary>
    /// In this case,
    ...
    public void Exists()
    {
        ...
        ResolveAssemblyReference task = new()
        {
            ...
            AssemblyFiles = [new TaskItem(UnifyMeDll_V10Path)],
        ...
        resolvedFile.GetMetadata("FusionName").ShouldBe("UnifyMe, Version=1.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089, ProcessorArchitecture=MSIL", StringCompareShould.IgnoreCase);
    ...
    public void ExistsPromotedDependencyInTheDenyList()
    {
        ...
        try
        {
            ...
            ResolveAssemblyReference task = new()
            {
                ...
                InstalledAssemblySubsetTables = [new TaskItem(subsetListPath)],

                BuildEngine = engine,
                Assemblies = [new TaskItem("DependsOnUnified, Version=1.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089")],
                SearchPaths = DefaultPaths,
                AppConfigFile = appConfigFile,
            };
    ...
    {
        TaskItem taskItem = new(UnifyMeDll_V05Path);
        ...
        Assert.True(succeeded);
        ITaskItem resolvedFile = Assert.Single(task.ResolvedFiles);
        Assert.Equal(resolvedFile.ItemSpec, taskItem.ItemSpec);
