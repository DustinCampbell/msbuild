...
#pragma warning restore CA2000
        ...
        private void VerifyStateInternal(BuildManagerState requiredState)
        {
            ...
            {
                Assumed.Unreachable($"Expected state {requiredState}, actual state {_buildManagerState}");
            }
        }
        ...
        private static I ExpectPacketType<I>(INodePacket packet, NodePacketType expectedType) where I : class, INodePacket
        {
            ...
            if (castPacket == null)
            {
                Assumed.Unreachable($"Incorrect packet type: {packet.Type} should have been {expectedType}");
            }
