...
internal sealed partial class CoordinatorClient
{
    ...
    {
        /// <summary>
        ///  Owns the coordinator grant and is responsible for flowing and restoring the grant ID.
        /// </summary>
        Root,

        /// <summary>
        ///  Joins an inherited coordinator grant without owning its environment state.
        /// </summary>
        Nested,
    }
}
