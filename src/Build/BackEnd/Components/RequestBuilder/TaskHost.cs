        ...
        IBuildEngine10
    {
        ...
        public bool BuildProjectFilesInParallel(string[] projectFileNames, string[] targetNames, System.Collections.IDictionary[] globalProperties, System.Collections.IDictionary[] targetOutputsPerProject, string[] toolsVersion, bool useResultsCache, bool unloadProjectsOnCompletion)
        {
            ...
            ErrorUtilities.VerifyThrowArgument(
                (targetOutputsPerProject == null) || (projectFileNames.Length == targetOutputsPerProject.Length),
...
#pragma warning restore SYSLIB0050
            {
                _taskLoggingContext.LogWarning(subcategoryResourceName: null, BuildEventFileInfo.Empty, "ExpectedEventToBeSerializable", e.GetType().Name);
                return false;
            }
                    ...
                    for (int i = 0; i < results.Length; i++)
                    {
                        ...
                        if (!string.IsNullOrEmpty(results[i].SchedulerInducedError))
                        {
                            LoggingContext.LogErrorFromText(
                                ...
                                errorCode: null,
                                helpKeyword: null,
                                file: BuildEventFileInfo.From(ProjectFileOfTaskNode, LineNumberOfTaskNode, ColumnNumberOfTaskNode),
