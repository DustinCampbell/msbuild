                ...
                if (projects[i] != null)
                {
                    ...
                    if (!String.IsNullOrEmpty(projects[i].GetMetadata(ItemMetadataNames.PropertiesMetadataName)))
                    {
                        if (!PropertyParser.GetTableWithEscaping(
                                log,
                                ResourceUtilities.FormatResourceStringIgnoreCodeAndKeyword("General_OverridingProperties", projectNames[i]),
                    ...
                    if (!String.IsNullOrEmpty(projects[i].GetMetadata(ItemMetadataNames.AdditionalPropertiesMetadataName)))
                    {
                        if (!PropertyParser.GetTableWithEscaping(
                                log,
                                ResourceUtilities.FormatResourceStringIgnoreCodeAndKeyword("General_AdditionalProperties", projectNames[i]),
