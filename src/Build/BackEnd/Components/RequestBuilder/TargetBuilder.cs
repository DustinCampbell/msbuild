...
namespace Microsoft.Build.BackEnd
{
    ...
    internal class TargetBuilder : ITargetBuilder, ITargetBuilderCallback, IBuildComponent
    {
        ...
        {
            ArgumentNullException.ThrowIfNull(loggingContext, paramName: "projectLoggingContext");
            ArgumentNullException.ThrowIfNull(entry);
            ArgumentNullException.ThrowIfNull(callback, paramName: "requestBuilderCallback");
