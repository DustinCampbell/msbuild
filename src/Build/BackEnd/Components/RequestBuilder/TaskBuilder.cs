            ...
            ItemBucket bucket)
        {
            ...
            if (taskParameterAttribute != null)
            {
                ...
                if (taskItemInstance != null)
                {
                    ...
                    foreach (string outputItemSpec in bucket.Expander.ExpandAndSplitLeaveEscaped(taskParameterAttribute, ExpanderOptions.ExpandPropertiesAndMetadata, taskItemInstance.TaskParameterLocation))
                    {
