...
internal partial class LegacyExpander<P, I>
{
    ...
    private static partial class ItemExpander
    {
        ...
        internal static IList<T> ExpandItemVectorIntoItems<T>(
            ExpressionShredder.ItemExpressionCapture expressionCapture, LegacyExpander<P, I> expander, IItemProvider<I> items, IItemFactory<I, T> itemFactory,
        ...
        /// If ExpanderOptions.BreakOnNotEmpty was passed, expression was going to be non-empty, and it broke out early, returns null. Otherwise the result can be trusted.
        /// </summary>
        internal static string ExpandItemVectorsIntoString(LegacyExpander<P, I> expander, string expression, IItemProvider<I> items, ExpanderOptions options, IElementLocation elementLocation)
        {
            if ((options & ExpanderOptions.ExpandItems) == 0 || expression.Length == 0)
            {
                return expression;
