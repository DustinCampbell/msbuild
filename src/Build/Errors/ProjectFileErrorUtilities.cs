...
internal static class ProjectFileErrorUtilities
{
    ...
    public static void ThrowInvalidProjectFile(
        ...
        string resourceName,
        params object?[]? args)
        => ThrowInvalidProjectFile(errorSubCategoryResourceName: null, projectFile, innerException: null, resourceName, args);
    ...
    /// </summary>
    /// <param name="projectFile">The invalid project file.</param>
    /// <param name="innerException">Any inner exception. May be <see langword="null"/>.</param>
    /// <param name="resourceName">The resource string for the error message.</param>
    /// <param name="args">Extra arguments for formatting the error message.</param>
    [DoesNotReturn]
    public static void ThrowInvalidProjectFile(
        ...
        string resourceName,
        params object?[]? args)
        => ThrowInvalidProjectFile(errorSubCategoryResourceName: null, projectFile, innerException, resourceName, args);
    ...
    public static void ThrowInvalidProjectFile(
        ...
        string resourceName,
        params object?[]? args)
        => ThrowInvalidProjectFile(errorSubCategoryResourceName, projectFile, innerException: null, resourceName, args);
        ...
        params object?[]? args)
    {
        if (!condition)
        {
            ThrowInvalidProjectFile(errorSubCategoryResourceName, projectFile, innerException, resourceName, args);
        }
    }
}
