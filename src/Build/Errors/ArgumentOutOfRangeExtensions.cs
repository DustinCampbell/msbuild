...
internal static class ArgumentOutOfRangeExtensions
{
    ...
    private static void ThrowZero<T>(T value, string? paramName) =>
        throw new ArgumentOutOfRangeException(
            paramName,
            value,
            ResourceUtilities.FormatString(ResourceUtilities.GetResourceString("ArgumentOutOfRange_Generic_MustBeNonZero"), paramName, value));
    ...
    private static void ThrowNegative<T>(T value, string? paramName) =>
        throw new ArgumentOutOfRangeException(
            paramName,
            value,
            ResourceUtilities.FormatString(ResourceUtilities.GetResourceString("ArgumentOutOfRange_Generic_MustBeNonNegative"), paramName, value));
    ...
    private static void ThrowNegativeOrZero<T>(T value, string? paramName) =>
        throw new ArgumentOutOfRangeException(
            paramName,
            value,
            ResourceUtilities.FormatString(ResourceUtilities.GetResourceString("ArgumentOutOfRange_Generic_MustBeNonNegativeNonZero"), paramName, value));
    ...
    private static void ThrowGreater<T>(T value, T other, string? paramName) =>
        throw new ArgumentOutOfRangeException(
            paramName,
            value,
            ResourceUtilities.FormatString(ResourceUtilities.GetResourceString("ArgumentOutOfRange_Generic_MustBeLessOrEqual"), paramName, value, other));
    ...
    private static void ThrowGreaterEqual<T>(T value, T other, string? paramName) =>
        throw new ArgumentOutOfRangeException(
            paramName,
            value,
            ResourceUtilities.FormatString(ResourceUtilities.GetResourceString("ArgumentOutOfRange_Generic_MustBeLess"), paramName, value, other));
    ...
    private static void ThrowLess<T>(T value, T other, string? paramName) =>
        throw new ArgumentOutOfRangeException(
            paramName,
            value,
            ResourceUtilities.FormatString(ResourceUtilities.GetResourceString("ArgumentOutOfRange_Generic_MustBeGreaterOrEqual"), paramName, value, other));
    ...
    private static void ThrowLessEqual<T>(T value, T other, string? paramName) =>
        throw new ArgumentOutOfRangeException(
            paramName,
            value,
            ResourceUtilities.FormatString(ResourceUtilities.GetResourceString("ArgumentOutOfRange_Generic_MustBeGreater"), paramName, value, other));
    ...
    private static void ThrowEqual<T>(T value, T other, string? paramName) =>
        throw new ArgumentOutOfRangeException(
            paramName,
            value,
            ResourceUtilities.FormatString(ResourceUtilities.GetResourceString("ArgumentOutOfRange_Generic_MustBeNotEqual"), paramName, (object?)value ?? "null", (object?)other ?? "null"));
    ...
    private static void ThrowNotEqual<T>(T value, T other, string? paramName) =>
        throw new ArgumentOutOfRangeException(
            paramName,
            value,
            ResourceUtilities.FormatString(ResourceUtilities.GetResourceString("ArgumentOutOfRange_Generic_MustBeEqual"), paramName, (object?)value ?? "null", (object?)other ?? "null"));
