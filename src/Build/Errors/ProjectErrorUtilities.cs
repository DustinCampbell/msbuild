...
internal static class ProjectErrorUtilities
{
    ...
    [DoesNotReturn]
    public static void ThrowInvalidProject<T0>(
        IElementLocation elementLocation,
        string resourceName,
        T0 arg0)
        => ThrowInvalidProject(errorSubCategoryResourceName: null, elementLocation, resourceName, arg0);
    ...
    [DoesNotReturn]
    public static void ThrowInvalidProject<T0, T1>(
        IElementLocation elementLocation,
        string resourceName,
        T0 arg0,
        T1 arg1)
        => ThrowInvalidProject(errorSubCategoryResourceName: null, elementLocation, resourceName, arg0, arg1);
    ...
    [DoesNotReturn]
    public static void ThrowInvalidProject<T0, T1, T2>(
        IElementLocation elementLocation,
        string resourceName,
        T0 arg0,
        T1 arg1,
        T2 arg2)
        => ThrowInvalidProject(errorSubCategoryResourceName: null, elementLocation, resourceName, arg0, arg1, arg2);
    ...
    [DoesNotReturn]
    public static void ThrowInvalidProject<T0, T1, T2, T3>(
        IElementLocation elementLocation,
        string resourceName,
        T0 arg0,
        T1 arg1,
        T2 arg2,
        T3 arg3)
        => ThrowInvalidProject(errorSubCategoryResourceName: null, elementLocation, resourceName, arg0, arg1, arg2, arg3);
    ...
    public static void ThrowInvalidProject(
        ...
        string resourceName,
        params object?[]? args)
        => ThrowInvalidProject(errorSubCategoryResourceName: null, elementLocation, resourceName, args);
    ...
    public static void VerifyThrowInvalidProject(
        ...
        IElementLocation elementLocation,
        string resourceName)
        => VerifyThrowInvalidProject(condition, errorSubCategoryResourceName: null, elementLocation, resourceName);
    ...
    /// <param name="resourceName">The resource string for the error message.</param>
    /// <param name="arg0"></param>
    public static void VerifyThrowInvalidProject<T0>(
        [DoesNotReturnIf(false)] bool condition,
        IElementLocation elementLocation,
        string resourceName,
        T0 arg0)
        => VerifyThrowInvalidProject(condition, errorSubCategoryResourceName: null, elementLocation, resourceName, arg0);
    ...
    /// <param name="arg0"></param>
    /// <param name="arg1"></param>
    public static void VerifyThrowInvalidProject<T0, T1>(
        [DoesNotReturnIf(false)] bool condition,
        IElementLocation elementLocation,
        string resourceName,
        T0 arg0,
        T1 arg1)
        => VerifyThrowInvalidProject(condition, errorSubCategoryResourceName: null, elementLocation, resourceName, arg0, arg1);
    ...
    /// <param name="arg1"></param>
    /// <param name="arg2"></param>
    public static void VerifyThrowInvalidProject<T0, T1, T2>(
        [DoesNotReturnIf(false)] bool condition,
        IElementLocation elementLocation,
        string resourceName,
        T0 arg0,
        T1 arg1,
        T2 arg2)
        => VerifyThrowInvalidProject(condition, errorSubCategoryResourceName: null, elementLocation, resourceName, arg0, arg1, arg2);
    ...
    /// <param name="arg2"></param>
    /// <param name="arg3"></param>
    public static void VerifyThrowInvalidProject<T0, T1, T2, T3>(
        [DoesNotReturnIf(false)] bool condition,
        IElementLocation elementLocation,
        string resourceName,
        T0 arg0, T1 arg1, T2 arg2, T3 arg3)
        => VerifyThrowInvalidProject(condition, errorSubCategoryResourceName: null, elementLocation, resourceName, arg0, arg1, arg2, arg3);
    ...
    ///  The resource string for the error sub-category (can be <see langword="null"/>).
    /// </param>
    /// <param name="elementLocation">The <see cref="IElementLocation"/> of the element.</param>
    /// <param name="resourceName">The resource string for the error message.</param>
    public static void VerifyThrowInvalidProject(
        ...
        string resourceName)
    {
        if (!condition)
        {
            ThrowInvalidProject(errorSubCategoryResourceName, elementLocation, resourceName, args: null);
        }
    }
