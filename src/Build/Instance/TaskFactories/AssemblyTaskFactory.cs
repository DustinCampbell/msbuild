...
namespace Microsoft.Build.BackEnd
{
    ...
    internal class AssemblyTaskFactory : ITaskFactory3
    {
        ...
        public bool Initialize(string taskName, IDictionary<string, TaskPropertyInfo> parameterGroup, string taskBody, IBuildEngine taskFactoryLoggingHost)
            => Assumed.Unreachable<bool>("Use internal call to properly initialize the assembly task factory");
        ...
        public ITask CreateTask(IBuildEngine taskFactoryLoggingHost)
            => Assumed.Unreachable<ITask>("Use internal call to properly create a task instance from the assembly task factory");
...
#pragma warning restore SA1111, SA1009 // Closing parenthesis should be on line of last parameter
            ...
            in TaskHostParameters taskIdentityParameters)
        {
            ...
            {
                Assumed.Unreachable($"How did we get two runtime values that were unmergeable? TaskIdentity Runtime: {taskIdentityParameters.Runtime}, FactoryIdentity Runtime: {factoryIdentityParameters.Runtime}.");
            }
            ...
            {
                Assumed.Unreachable($"How did we get two architecture values that were unmergeable? TaskIdentity Architecture: {taskIdentityParameters.Architecture}, FactoryIdentity Architecture: {factoryIdentityParameters.Architecture}.");
            }
