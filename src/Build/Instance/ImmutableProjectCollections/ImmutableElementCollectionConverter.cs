        ...
        where T : class, IKeyed
    {
        ...
        private sealed class ValuesCollection : ICollection<T>
        {
            ...
            public void CopyTo(T[] array, int arrayIndex, int count)
            {
                ...
                ArgumentGuard.VerifyCollectionCopyToArguments(array, arrayIndex, count);
            ...
            {
                ArgumentGuard.VerifyCollectionCopyToArguments(array, arrayIndex, _projectElements.Count);
