...
namespace Microsoft.Build.BackEnd.Logging
{
    ...
    internal class ParallelConsoleLogger : BaseConsoleLogger
    {
        ...
        {
            ArgumentNullException.ThrowIfNull(e.BuildEventContext, paramName: "BuildEventContext");
            ArgumentNullException.ThrowIfNull(e.ParentProjectBuildEventContext, paramName: "ParentProjectBuildEventContext");
