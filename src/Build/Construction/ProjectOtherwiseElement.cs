...
namespace Microsoft.Build.Construction
{
    ...
    public class ProjectOtherwiseElement : ProjectElementContainer
    {
        ...
        /// </summary>
        internal ProjectOtherwiseElement(ElementData elementData, ProjectElementContainer parent, ProjectRootElement containingProject)
        ...
        internal static ProjectOtherwiseElement CreateDisconnected(ProjectRootElement containingProject)
        {
            ...
            {
                var data = containingProject.CreateElementData(XMakeElements.otherwise);
                return new ProjectOtherwiseElement(data, null, containingProject);
            }
