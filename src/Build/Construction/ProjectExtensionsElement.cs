...
namespace Microsoft.Build.Construction
{
    ...
    public class ProjectExtensionsElement : ProjectElement
    {
        ...
        /// </summary>
        internal ProjectExtensionsElement(ElementData elementData, ProjectElementContainer parent, ProjectRootElement containingProject)
        ...
        internal static ProjectExtensionsElement CreateDisconnected(ProjectRootElement containingProject)
        {
            ...
            {
                var data = containingProject.CreateElementData(XMakeElements.projectExtensions);
                return new ProjectExtensionsElement(data, null, containingProject);
            }
