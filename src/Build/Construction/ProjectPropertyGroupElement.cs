...
namespace Microsoft.Build.Construction
{
    ...
    public class ProjectPropertyGroupElement : ProjectElementContainer
    {
        ...
        /// </summary>
        internal ProjectPropertyGroupElement(ElementData elementData, ProjectElementContainer parent, ProjectRootElement containingProject)
        ...
        internal static ProjectPropertyGroupElement CreateDisconnected(ProjectRootElement containingProject)
        {
            ...
            {
                var data = containingProject.CreateElementData(XMakeElements.propertyGroup);
                return new ProjectPropertyGroupElement(data, null, containingProject);
            }
