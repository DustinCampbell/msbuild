...
namespace Microsoft.Build.Construction
{
    ...
    public class ProjectItemGroupElement : ProjectElementContainer
    {
        ...
        {
            InvalidOperationException.ThrowIfFalse(parent is ProjectRootElement || parent is ProjectTargetElement || parent is ProjectWhenElement || parent is ProjectOtherwiseElement, SR.OM_CannotAcceptParent);
        }
