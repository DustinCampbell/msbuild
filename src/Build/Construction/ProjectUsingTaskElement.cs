...
namespace Microsoft.Build.Construction
{
    ...
    public class ProjectUsingTaskElement : ProjectElementContainer
    {
        ...
        public string AssemblyFile
        {
            ...
            set
            {
                ArgumentException.ThrowIfNullOrEmpty(value, paramName: XMakeAttributes.assemblyName);
        ...
        public string TaskName
        {
            ...
            set
            {
                ArgumentException.ThrowIfNullOrEmpty(value, paramName: XMakeAttributes.taskName);
