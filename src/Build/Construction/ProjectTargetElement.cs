...
namespace Microsoft.Build.Construction
{
    ...
    public class ProjectTargetElement : ProjectElementContainer
    {
        ...
        public string Inputs
        {
            ...
            set
            {
                ArgumentNullException.ThrowIfNull(value, paramName: XMakeAttributes.inputs);
        ...
        public string Outputs
        {
            ...
            set
            {
                ArgumentNullException.ThrowIfNull(value, paramName: XMakeAttributes.outputs);
        ...
        public string KeepDuplicateOutputs
        {
            ...
            set
            {
                ArgumentNullException.ThrowIfNull(value, paramName: XMakeAttributes.keepDuplicateOutputs);
        ...
        public string DependsOnTargets
        {
            ...
            set
            {
                ArgumentNullException.ThrowIfNull(value, paramName: XMakeAttributes.dependsOnTargets);
        ...
        public string BeforeTargets
        {
            ...
            set
            {
                ArgumentNullException.ThrowIfNull(value, paramName: XMakeAttributes.beforeTargets);
        ...
        public string AfterTargets
        {
            ...
            set
            {
                ArgumentNullException.ThrowIfNull(value, paramName: XMakeAttributes.afterTargets);
