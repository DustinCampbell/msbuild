...
public class ProjectTaskElement : ProjectElementContainer
{
    ...
    {
        [DebuggerStepThrough]
        get => GetAttributeValueOrEmpty(XMakeAttributes.continueOnError);

        [DebuggerStepThrough]
        set => SetOrRemoveAttribute(XMakeAttributes.continueOnError, value, "Set task ContinueOnError {0}", value);
    }
    ...
    {
        [DebuggerStepThrough]
        get => GetAttributeValueOrEmpty(XMakeAttributes.msbuildRuntime);

        [DebuggerStepThrough]
        set => SetOrRemoveAttribute(XMakeAttributes.msbuildRuntime, value, "Set task MSBuildRuntime {0}", value);
    }
    ...
    {
        [DebuggerStepThrough]
        get => GetAttributeValueOrEmpty(XMakeAttributes.msbuildArchitecture);

        [DebuggerStepThrough]
        set => SetOrRemoveAttribute(XMakeAttributes.msbuildArchitecture, value, "Set task MSBuildArchitecture {0}", value);
    }
    ...
    public ElementLocation ContinueOnErrorLocation
        => GetAttributeLocation(XMakeAttributes.continueOnError);
    ...
    public ElementLocation MSBuildRuntimeLocation
        => GetAttributeLocation(XMakeAttributes.msbuildRuntime);
    ...
    public ElementLocation MSBuildArchitectureLocation
        => GetAttributeLocation(XMakeAttributes.msbuildArchitecture);
    ...
    {
        ProjectOutputElement outputItem = ContainingProject.CreateOutputElement(taskParameter, itemType, propertyName: null);
    ...
    public ProjectOutputElement AddOutputProperty(string taskParameter, string propertyName)
    {
        ...
        return AddOutputProperty(taskParameter, propertyName, condition: null);
    }
    ...
    {
        ProjectOutputElement outputProperty = ContainingProject.CreateOutputElement(taskParameter, itemType: null, propertyName);
