    ...
    where I : class, IItem
{
    ...
    /// <summary>
    ///  Determines whether <paramref name="propertyName"/> is a valid property name.
    /// </summary>
    /// <param name="propertyName">The property name to validate.</param>
    /// <returns>
    ///  <see langword="true"/> when <paramref name="propertyName"/> is valid; otherwise,
    ///  <see langword="false"/>.
    /// </returns>
    private static bool IsValidPropertyName(StringSegment propertyName)
    {
        ...
        {
            if (!XmlUtilities.IsValidSubsequentElementNameCharacter(propertyName[index]))
            {
                return false;
            }
        }
