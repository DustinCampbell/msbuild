    ...
    where I : class, IItem
{
    ...
    public string ExpandIntoStringLeaveEscaped(string expression, ExpanderOptions options, IElementLocation location)
    {
        ...
        var context = new ExpanderContext(_properties, _loggingContext, _fileSystem, _propertiesUseTracker, location);

        string result = MetadataExpander.ExpandMetadataLeaveEscaped(expression, _metadata, options, location, _loggingContext);
        result = PropertyExpander.ExpandPropertiesLeaveEscaped(result, options, in context);
        ...
        where T : class, IItem
    {
        ...
        expression = PropertyExpander.ExpandPropertiesLeaveEscaped(expression, options, in context);
