    ...
    where I : class, IItem
{
    ...
    {
        var transformsEnumerator = ExpressionParser.GetReferencedItemExpressions(expression);
    ...
    internal IList<TaskItem> ExpandIntoTaskItemsLeaveEscaped(string expression, ExpanderOptions options, IElementLocation elementLocation)
        => ExpandIntoItemsLeaveEscaped(expression, (IItemFactory<I, TaskItem>)TaskItemFactory.Instance, options, elementLocation);
        ...
        where T : class, IItem
    {
        ...
        foreach (string split in ExpressionParser.SplitSemiColonSeparatedList(expression))
        {
            ...
            IList<T> itemsToAdd = ItemExpander.ExpandSingleItemVectorExpressionIntoItems(expander: this, split, _items, itemFactory, options, includeNullEntries: false, out isTransformExpression, elementLocation);
        ...
        where T : class, IItem
    {
        ...
        return ItemExpander.ExpandSingleItemVectorExpressionIntoItems(expander: this, expression, _items, itemFactory, options, includeNullItems, out isTransformExpression, elementLocation);
    }
