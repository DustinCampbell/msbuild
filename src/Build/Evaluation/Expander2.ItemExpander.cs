    ...
    where I : class, IItem
{
    ...
    private static class ItemExpander
    {
        ...
        ///
        /// For each function, the full list of items will be iteratively transformed using the output of the previous.
        ///
        ...
        internal static IList<T> ExpandSingleItemVectorExpressionIntoItems<T>(
            Expander2<P, I> expander, string expression, IItemProvider<I> items, IItemFactory<I, T> itemFactory, ExpanderOptions options,
        ...
        internal static IList<T> ExpandExpressionCaptureIntoItems<T>(
            ExpressionShredder.ItemExpressionCapture expressionCapture, Expander2<P, I> expander, IItemProvider<I> items, IItemFactory<I, T> itemFactory,
        ...
        /// If ExpanderOptions.BreakOnNotEmpty was passed, expression was going to be non-empty, and it broke out early, returns null. Otherwise the result can be trusted.
        /// </summary>
        internal static string ExpandItemVectorsIntoString(Expander2<P, I> expander, string expression, IItemProvider<I> items, ExpanderOptions options, IElementLocation elementLocation)
        {
        ...
        /// </summary>
        private static class IntrinsicItemFunctions
        {
            /// <summary>
