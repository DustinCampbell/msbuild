    ...
    where I : class, IItem
{
    ...
    private static class ItemExpander
    {
            ...
            where T : class, IItem
        {
            ...
            return TryExpandSingleItemVectorExpressionIntoExpressionCapture(expression, options, elementLocation, out var expressionCapture)
                ? ExpandExpressionCaptureIntoItems(expressionCapture, expander, items, itemFactory, options, includeNullEntries, out isTransformExpression, elementLocation)
                : null;
        }
            ...
            where T : class, IItem
        {
            ...
            brokeEarlyNonEmpty = TryExpandExpressionCapture(
                expander,
                expressionCapture,
                items,
                elementLocation,
        ...
        internal static string ExpandItemVectorsIntoString(Expander<P, I> expander, string expression, IItemProvider<I> items, ExpanderOptions options, IElementLocation elementLocation)
        {
            ...
            do
            {
                var currentItem = matchesEnumerator.Current;
