    ...
    where I : class, IItem
{
    private struct FunctionBuilder
    {
        ...
        /// <c>AvailableStaticMembers.PropertyFunctionMembers</c>.
        /// </summary>
        [DynamicallyAccessedMembers(
            DynamicallyAccessedMemberTypes.PublicConstructors |
            DynamicallyAccessedMemberTypes.PublicMethods |
        ...
        /// preserved for trimming by <c>AvailableStaticMembers.PropertyFunctionMembers</c>) or a runtime value's
        ...
        [UnconditionalSuppressMessage("Trimming", "IL2069",
            Justification = "Receiver type comes from the static-member allowlist (public members preserved by AvailableStaticMembers.PropertyFunctionMembers) or a runtime GetType(); only public members are bound. See the summary for the DAM-flow rationale.")]
