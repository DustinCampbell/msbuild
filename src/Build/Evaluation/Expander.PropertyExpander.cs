    ...
    where I : class, IItem
{
    ...
    private readonly ref struct PropertyExpander
    {
        ...
        private object ExpandPropertyBody(StringSegment propertyBody)
        {
            ...
            if (!PropertyFunctionParser.TryParse(propertyBody, _context.Location, out PropertyFunctionExpression propertyFunction))
            {
            ...
            ref readonly PropertyFunctionInvocation firstInvocation =
                ref OneOrMany<PropertyFunctionInvocation>.ItemRef(in invocations, 0);
            ...
            for (int i = 0; i < invocationCount; i++)
            {
                ref readonly PropertyFunctionInvocation invocation = ref (i == 0
                    ? ref firstInvocation
                    : ref OneOrMany<PropertyFunctionInvocation>.ItemRef(in invocations, i));
                try
                {
