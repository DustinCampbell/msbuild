...
internal abstract class GenericExpressionNode
{
    ...
    internal abstract bool TryVersionEvaluate(ConditionEvaluator.IConditionEvaluationState state, [NotNullWhen(true)] out Version? result);
    ...
    internal virtual bool PossibleAndCollision { get => false; set { } }

    internal virtual bool PossibleOrCollision { get => false; set { } }
