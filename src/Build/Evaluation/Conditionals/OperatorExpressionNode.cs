...
internal abstract class OperatorExpressionNode : GenericExpressionNode
{
    ...
    /// </summary>
    internal GenericExpressionNode LeftChild { get; }

    /// <summary>
    /// Storage for the right child.
    /// </summary>
    internal GenericExpressionNode RightChild { get; }

    protected OperatorExpressionNode(GenericExpressionNode leftChild, GenericExpressionNode rightChild)
    {
        LeftChild = leftChild;
