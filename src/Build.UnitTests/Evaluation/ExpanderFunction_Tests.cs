...
namespace Microsoft.Build.Engine.UnitTests.Evaluation
{
    public class ExpanderFunction_Tests
    {
        ...
        {
            FunctionArguments.TryConvertToInt(null, out int actual).ShouldBeFalse();
            actual.ShouldBe(0);
        }
        ...
        public void TryConvertToIntGivenDouble()
        {
            ...
            FunctionArguments.TryConvertToInt(value, out int actual).ShouldBeTrue();
            actual.ShouldBe(10);
        }
        ...
        public void TryConvertToIntGivenDoubleWithLessThanIntMinValue()
        {
            ...
            FunctionArguments.TryConvertToInt(value, out int actual).ShouldBeFalse();
            actual.ShouldBe(0);
        }
        ...
        {
            FunctionArguments.TryConvertToLong(null, out long actual).ShouldBeFalse();
            actual.ShouldBe(0);
        }
        ...
        {
            const double value = 10.0;
            FunctionArguments.TryConvertToLong(value, out long actual).ShouldBeTrue();
            actual.ShouldBe(10);
        }
        ...
        public void TryConvertToLongGivenDoubleWithLongMaxValueShouldNotThrow()
        {
            ...
            _ = Should.NotThrow(() => FunctionArguments.TryConvertToLong((double)long.MaxValue, out _));
        }
        ...
        public void TryConvertToLongGivenDoubleWithLongMaxValueFramework()
        {
            ...
            bool result = FunctionArguments.TryConvertToLong((double)longMaxValue, out long actual);
        ...
        public void TryConvertToLongGivenDoubleWithLessThanLongMinValue()
        {
            ...
            FunctionArguments.TryConvertToLong(value, out long actual).ShouldBeFalse();
            actual.ShouldBe(0);
        }
        ...
        {
            FunctionArguments.TryConvertToDouble(null, out double actual).ShouldBeFalse();
            actual.ShouldBe(0);
        }
        ...
        {
            const double value = 10.0;
            FunctionArguments.TryConvertToDouble(value, out double actual).ShouldBeTrue();
