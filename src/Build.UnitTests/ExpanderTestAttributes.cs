...
/// <summary>
///  Identifies a theory that runs only when the modern expander is selected.
/// </summary>
public sealed class ModernExpanderOnlyTheoryAttribute : TheoryAttribute
{
    /// <summary>
    ///  Initializes a new instance of the <see cref="ModernExpanderOnlyTheoryAttribute"/> class.
    /// </summary>
    /// <param name="sourceFilePath">The source file path supplied by the compiler.</param>
    /// <param name="sourceLineNumber">The source line number supplied by the compiler.</param>
    public ModernExpanderOnlyTheoryAttribute(
        [CallerFilePath] string? sourceFilePath = null,
        [CallerLineNumber] int sourceLineNumber = -1)
        : base(sourceFilePath, sourceLineNumber)
    {
...
/// <summary>
///  Identifies a theory that runs only when <c>LegacyExpander</c> is selected.
/// </summary>
public sealed class LegacyExpanderOnlyTheoryAttribute : TheoryAttribute
{
    /// <summary>
    ///  Initializes a new instance of the <see cref="LegacyExpanderOnlyTheoryAttribute"/> class.
    /// </summary>
    /// <param name="sourceFilePath">The source file path supplied by the compiler.</param>
    /// <param name="sourceLineNumber">The source line number supplied by the compiler.</param>
    public LegacyExpanderOnlyTheoryAttribute(
        [CallerFilePath] string? sourceFilePath = null,
        [CallerLineNumber] int sourceLineNumber = -1)
        : base(sourceFilePath, sourceLineNumber)
    {
