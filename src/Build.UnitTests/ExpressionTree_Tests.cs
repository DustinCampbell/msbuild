...
namespace Microsoft.Build.UnitTests
{
    public class ExpressionTreeTest
    {
        ...
        public void FunctionTests()
        {
            ...
            tree = Parser.Parse(command, ParserOptions.AllowAll, MockElementLocation.Instance).Node;
        ...
        private void AssertParseEvaluateThrow(string expression, Expander<ProjectPropertyInstance, ProjectItemInstance> expander, ConditionEvaluator.IConditionEvaluationState state)
        {
            ...
            try
            {
                ...
                ParseResult result = Parser.Parse(expression, ParserOptions.AllowAll, MockElementLocation.Instance);
                result.ThrowIfError();
