...
namespace Microsoft.Build.Utilities
{
    ...
    public static class ToolLocationHelper
    {
        ...
        /// </summary>
        [SupportedOSPlatform("windows")]
        internal static void GatherSDKsFromRegistryImpl(Dictionary<TargetPlatformSDK, TargetPlatformSDK> platformMonikers, string registryKeyRoot, RegistryView registryView, RegistryHive registryHive, IRegistryService registryService, FileExists fileExists)
        {
        ...
        {
            IRegistryService registryService = RegistryService.Instance;
