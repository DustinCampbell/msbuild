...
/// </summary>
[Serializable]
internal sealed class MSBuildNameIgnoreCaseComparer : IConstrainedEqualityComparer<string>, IEqualityComparer<string>
{
    /// <summary>
    /// The default immutable comparer instance.
    /// </summary>
    internal static MSBuildNameIgnoreCaseComparer Instance { get; } = new MSBuildNameIgnoreCaseComparer();
    ...
    public bool Equals(string x, string y)
        => Equals(x, y, 0, y?.Length ?? 0);

    public int GetHashCode(string obj)
        => GetHashCode(obj, 0, obj?.Length ?? 0);
    ...
    public bool Equals(string compareToString, string constrainedString, int start, int lengthToCompare)
    {
        ...
        if (compareToString == null ||
            constrainedString == null ||
            lengthToCompare != compareToString.Length)
        {
            return false;
        }
