...
internal sealed class LogMessagePacketBase : INodePacket
{
    ...
    /// </summary>
    internal LogMessagePacketBase(ITranslator translator)
    ...
    /// </summary>
    private bool EventCanSerializeItself(LoggingEventType eventType, MethodInfo methodInfo)
        => methodInfo != null;
    ...
    /// </remarks>
    private static void WriteEventToStream(BuildEventArgs buildEvent, LoggingEventType eventType, ITranslator translator)
    {
    ...
    /// </summary>
    private static void WriteBuildWarningEventToStream(BuildWarningEventArgs buildWarningEventArgs, ITranslator translator)
    {
    ...
    /// </summary>
    private static void WriteBuildErrorEventToStream(BuildErrorEventArgs buildErrorEventArgs, ITranslator translator)
    {
    ...
    /// </summary>
    private static void WriteTaskCommandLineEventToStream(TaskCommandLineEventArgs taskCommandLineEventArgs, ITranslator translator)
    {
    ...
    /// </summary>
    private static void WriteBuildMessageEventToStream(BuildMessageEventArgs buildMessageEventArgs, ITranslator translator)
    {
    ...
    /// </summary>
    private static void WriteResponseFileUsedEventToStream(ResponseFileUsedEventArgs responseFileUsedEventArgs, ITranslator translator)
    {
    ...
    /// Override to customize serialization per-assembly without relying on compile directives.
    /// </remarks>
    private static BuildEventArgs ReadEventFromStream(LoggingEventType eventType, ITranslator translator)
    {
        string message = null;
        ...
        return eventType switch
        {
            ...
            LoggingEventType.ResponseFileUsedEvent => ReadResponseFileUsedEventFromStream(translator),
    ...
    /// </summary>
    private static BuildWarningEventArgs ReadBuildWarningEventFromStream(ITranslator translator, string message, string helpKeyword, string senderName)
    {
        string code = null;
        translator.Translate(ref code);
    ...
    /// </summary>
    private static BuildErrorEventArgs ReadTaskBuildErrorEventFromStream(ITranslator translator, string message, string helpKeyword, string senderName)
    {
        string code = null;
        translator.Translate(ref code);
    ...
    /// </summary>
    private static TaskCommandLineEventArgs ReadTaskCommandLineEventFromStream(ITranslator translator)
    {
    ...
    /// </summary>
    private static BuildMessageEventArgs ReadBuildMessageEventFromStream(ITranslator translator, string message, string helpKeyword, string senderName)
    {
        MessageImportance importance = MessageImportance.Normal;
    ...
    private static ResponseFileUsedEventArgs ReadResponseFileUsedEventFromStream(ITranslator translator)
    {
        string responseFilePath = string.Empty;
        translator.Translate(ref responseFilePath);

        return new ResponseFileUsedEventArgs(responseFilePath);
    }
}
