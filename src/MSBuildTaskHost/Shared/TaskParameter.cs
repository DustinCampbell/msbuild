...
/// </summary>
internal sealed class TaskParameter : MarshalByRefObject, ITranslatable
{
    /// <summary>
    ...
    /// </summary>
    private sealed class TaskParameterTaskItem : MarshalByRefObject, ITaskItem, ITaskItem2, ITranslatable
    {
        /// <summary>
        /// The item spec
        /// </summary>
        ...
        internal TaskParameterTaskItem(ITaskItem copyFrom)
        {
            if (copyFrom is ITaskItem2 copyFromAsITaskItem2)
            {
                ...
                {
                    _customEscapedMetadata = new Dictionary<string, string>(MSBuildNameIgnoreCaseComparer.Instance);
        ...
        {
            IDictionary<string, string> clonedMetadata = new Dictionary<string, string>(MSBuildNameIgnoreCaseComparer.Instance);
        ...
        public void Translate(ITranslator translator)
        {
            ...
            translator.TranslateDictionary(ref _customEscapedMetadata, MSBuildNameIgnoreCaseComparer.Instance);
