...
/// </summary>
internal sealed class OutOfProcTaskHostNode : MarshalByRefObject, INodePacketFactory, INodePacketHandler, IBuildEngine3
{
    /// <summary>
    ...
    {
        // We don't have access to ICancellableTask on .NET Framework 3.5, so we just abort the thread.
