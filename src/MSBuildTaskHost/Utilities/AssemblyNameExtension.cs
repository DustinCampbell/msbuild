...
using Architecture = System.Reflection.ProcessorArchitecture;
...
internal sealed class AssemblyNameExtension : ISerializable, IEquatable<AssemblyNameExtension>, ITranslatable
{
    ...
    private AssemblyNameExtension(SerializationInfo info, StreamingContext context)
    {
        ...
        if (hasAssemblyName)
        {
            ...
            var processorArchitecture = (Architecture)info.GetInt32("cpuarch");
            ...
            var hashAlgorithm = (AssemblyHashAlgorithm)info.GetInt32("hashAlg");
    ...
    /// </summary>
    internal Architecture ProcessorArchitecture =>
        asAssemblyName?.ProcessorArchitecture ?? Architecture.None;
