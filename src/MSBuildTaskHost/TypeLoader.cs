...
internal sealed class TypeLoader
{
    ...
    /// </summary>
    private static ConcurrentDictionary<TypeFilter, ConcurrentDictionary<AssemblyLoadInfo, AssemblyInfoToLoadedTypes>> s_cacheOfReflectionOnlyLoadedTypesByFilter = new();
    ...
    /// </summary>
    private sealed class AssemblyInfoToLoadedTypes
    {
        /// <summary>
