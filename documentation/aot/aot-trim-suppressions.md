...
| [ReflectionInvoker.cs:284](../../src/Build/Evaluation/Expander/ReflectionInvoker.cs#L284) | IL2070 | `ReflectionInvoker.FindPublicMethodBySignature(...)` | `receiverType.GetMethods(bindingFlags)` | Same public-only flags invariant and annotated receiver parameter. | Vetted |
| [ReflectionInvoker.cs:332](../../src/Build/Evaluation/Expander/ReflectionInvoker.cs#L332) | IL3050 | `ReflectionInvoker.InvokeWithArgumentCoercion(...)` | `Enum.GetValues(Type)` (rooted) | `Enum.GetValues(Type)` is unreachable via property functions - no way to supply a `Type` arg (MSB4185/MSB4186) - and would fail observably if reached; proven under Native AOT by `PropertyFunctionAotTests`. | Vetted |
| [ReflectionInvoker.cs:332](../../src/Build/Evaluation/Expander/ReflectionInvoker.cs#L332) | IL2070 | `ReflectionInvoker.InvokeWithArgumentCoercion(...)` | `receiverType.GetMethods(bindingFlags)` | Same public-only flags invariant and annotated receiver parameter. | Vetted |
