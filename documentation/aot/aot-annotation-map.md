...
| --- | --- | --- | --- |
| **Property-function receivers** | [`Function._receiverType` + ctor param](../../src/Build/Evaluation/Expander.Function.cs); [`FunctionBuilder.SetReceiverType`](../../src/Build/Evaluation/Expander.FunctionBuilder.cs); [`ReflectionInvoker` receiver parameters](../../src/Build/Evaluation/Expander/ReflectionInvoker.cs) | `PublicConstructors \| PublicMethods \| PublicProperties \| PublicFields` | **Yes** - property functions invoke constructors (`new`), call methods, read properties **and** fields (`MaxValue`); kept in sync with `AvailableStaticMembers.PropertyFunctionMembers`. Narrowing would break field/constructor access. |
